	...
	public class OrderMap : IEntityTypeConfiguration<Order>
	{
		public void Configure(EntityTypeBuilder<Order> builder)
		{
				...
				builder.HasIndex(e => e.CustomerId)
					.HasName("Order_CustomersOrders");

				builder.HasIndex(e => e.EmployeeId)
					.HasName("Order_EmployeesOrders");

				builder.HasIndex(e => e.OrderDate)
					.HasName("Order_OrderDate");

				builder.HasIndex(e => e.ShipPostalCode)
					.HasName("Order_ShipPostalCode");

				builder.HasIndex(e => e.ShipVia)
					.HasName("Order_ShippersOrders");

				builder.HasIndex(e => e.ShippedDate)
					.HasName("Order_ShippedDate");

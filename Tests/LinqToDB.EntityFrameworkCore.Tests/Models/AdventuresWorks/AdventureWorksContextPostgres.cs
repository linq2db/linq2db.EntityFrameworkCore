...
{
	public class AdventureWorksContextPostgres : DbContext
	{
		public AdventureWorksContextPostgres(DbContextOptions options)
			: base(options)
		{
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<SalesOrder>(
				entity =>
				{
					...
					entity.Property(e => e.SalesOrderID).ForNpgsqlUseSequenceHiLo("SalesOrderNumber", "SalesLT");
